...
import com.github.mouse0w0.coffeemaker.template.handler.*;
...
import com.github.mouse0w0.coffeemaker.template.tree.BtClassVisitor;
...
public class TemplateParserImpl implements TemplateParser {
    ...
    public TemplateParserImpl() {
        ...
        handlers.add(new MapVarHandler());
